    ...
    public partial class Form1 : Form
    {
        ...
        private void Calculate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (R < 0)
                {
                    MessageBox.Show("Уважаемый пользователь, пожалуйста, введите положительноу число");
                }
                if (M < 0)
                {
                    MessageBox.Show("Уважаемый пользователь, пожалуйста, введите положительное число");
                }
            }
